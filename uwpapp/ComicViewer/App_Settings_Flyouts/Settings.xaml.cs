...
namespace ComicViewer
{
    ...
    public sealed partial class Settings : UserControl
    {
        ...
        private void UpdateControls()
        {
            ...
            chkOpacity.IsChecked = AppSettings.Opacity < 1.0f ? true : false;
            valueOpacity.Value = AppSettings.Opacity < 1.0f ? AppSettings.Opacity : 1.0f;
        ...
        private void bttnApply_Click(object sender, RoutedEventArgs e)
        {
            if (AppSettings != null)
            {
                ...
                if(chkOpacity.IsChecked ?? false)
                {
                    AppSettings.Opacity = (float) valueOpacity.Value;
                }
                else
                {
                    AppSettings.Opacity = 1.0f;
                }
